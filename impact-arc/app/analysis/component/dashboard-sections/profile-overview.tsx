  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Influencer profile information and key metrics</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{profileRating.score || "7/10"}</Badge>
              ...
              <div className="flex items-center gap-2">
                <Badge variant="outline">{profileRating.imageQuality || "8/10"}</Badge>
                <span className="text-sm text-muted-foreground">Image Quality</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline">{profileRating.linkCredibility || "6/10"}</Badge>
                <span className="text-sm text-muted-foreground">Link Credibility</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{contentRating.score || "7/10"}</Badge>
                <span className="text-sm text-muted-foreground">Overall</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline">{contentRating.consistency || "80%"}</Badge>
                <span className="text-sm text-muted-foreground">Consistency</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline">{contentRating.categoryAlignment || "75%"}</Badge>
                <span className="text-sm text-muted-foreground">Category Alignment</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{authenticityRating.score || "6/10"}</Badge>
                <span className="text-sm text-muted-foreground">Authenticity</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="outline">{authenticityRating.riskPercentage || "15%"}</Badge>
                <span className="text-sm text-muted-foreground">Risk Percentage</span>
              </div>
              <div className="flex items-center gap-2">
                <Badge variant="secondary">{publicPerceptionRating.score || "6/10"}</Badge>
                <span className="text-sm text-muted-foreground">Public Perception</span>
              </div>
            </div>
          </div>
        </div>
