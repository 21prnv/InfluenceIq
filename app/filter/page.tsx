...
export const metadata = {
  title: 'Creator Gallery | Filter by Category',
  description: 'Browse our curated collection of content creators across various categories. Filter by your interests to find your next favorite creator!',
};
